...
namespace Legacy.Maliev.DocumentService.Tests.Workflows;
...
public sealed class WorkflowContractTests
{
    ...
    {
        AssertMutationRejected(
            "          solution: Legacy.Maliev.DocumentService.slnx",
            "          solution: Legacy.Maliev.DocumentService.slnx\n      - run: dotnet  restore Legacy.Maliev.DocumentService.slnx");
    }
